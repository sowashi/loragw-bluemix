...
#define ADDRESS     "tcp://gg6d5e.messaging.internetofthings.ibmcloud.com:1883"
#define CLIENTID    "d:gg6d5e:LoRa:b827ebebc82e"
#define TOKEN       "GkOPLQ+k*fraD5zrk1"
#define USERID      "use-token-auth"
#define PASSWD      "GkOPLQ+k*fraD5zrk1"
...
int send2bluemix(char* sendmsg)
{
    ...
    printf("Waiting for up to %d seconds for publication of %s\n"
            ...
            (int)(TIMEOUT/1000), sendmsg, TOPIC, CLIENTID);
